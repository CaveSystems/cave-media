...
namespace Cave.Media.Audio
{
    ...
    public class InvalidAudioDeviceException : Exception
    {
        ...
        public InvalidAudioDeviceException() : base("Invalid audio device!") { }

        /// <summary>Initializes a new instance of the <see cref="InvalidAudioDeviceException"/> class.</summary>
        /// <param name="dev">The device.</param>
        public InvalidAudioDeviceException(string dev) : base(string.Format("Device '{0}' is not a valid audio device!", dev)) { }
        ...
        protected InvalidAudioDeviceException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
}