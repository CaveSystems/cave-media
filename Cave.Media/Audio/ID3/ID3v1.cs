...
/// <summary>Provides support for reading and writing ID3v1.0 and ID3v1.1 format.</summary>
public sealed class ID3v1 : MP3MetaFrame
{
    ...
    void ParseData()
    {
        if (data is null) throw new InvalidOperationException("Data is unset!");
    ...
    /// <summary>Creates a new empty ID3v1 tag.</summary>
    public ID3v1()
    {
    }

    /// <summary>Creates a ID3v1 tag instance containing the specified data.</summary>
    ...
    /// <summary>Provides the full Genre List supported by ID3v1.</summary>
    ...
    /// <summary>Album name the track belongs to.</summary>
    public string Album
    {
        get => album;
        set
    ...
    /// <summary>Semicolon separated list of performers.</summary>
    ...
    /// <summary>Genre this track belongs to.</summary>
    public string Genre
    {
        get => genre;
        set
    ...
    /// <summary>Returns true (tag has always 128 byte).</summary>
    ...
    /// <summary>Number of the track. Valid values range from 1..254.</summary>
    ...
    /// <summary>Reads a <see cref="ID3v1"/> tag directly from a file.</summary>
    ...
    /// <summary>Gets the full tag as string.</summary>
    /// <returns></returns>
    ...
    /// <summary>Directly writes a <see cref="ID3v1"/> tag to the specified file replacing the existing one (if any).</summary>
