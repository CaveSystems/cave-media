...
/// <summary>port audio - audio out implementation.</summary>
...
internal class PAOut : AudioOut
{
    ...
    IntPtr streamHandle;
    readonly FifoBuffer streamData = new FifoBuffer();
    ...
    /// <exception cref="Exception">Already started! or.</exception>
    ...
    /// <exception cref="Exception">Already stopped! or.</exception>
