...
namespace Cave.Media.Audio.MP3
{
    ...
    public class MP3AudioFrameHeader
    {
        ...
        {
            Data = value;
            Emphasis = (byte)(value & 3); value >>= 2;
            Original = (value & 1) == 1; value >>= 1;
            Copyright = (value & 1) == 1; value >>= 1;
            ModeExtension = (byte)(value & 3); value >>= 2;
            Channels = (MP3AudioFrameChannels)(value & 3); value >>= 2;
            Private = (value & 1) == 1; value >>= 1;
            Padding = (value & 1) == 1; value >>= 1;
            SamplingRateIndex = (ushort)(value & 3); value >>= 2;
            BitRateIndex = (ushort)(value & 0xF); value >>= 4;
            if ((BitRateIndex == 0) || (BitRateIndex > 14))
            {
                Validation = MP3AudioFrameHeadervalidation.InvalidBitRate;
                return;
            }
            Protection = (value & 1) == 0; value >>= 1;
            Layer = (MP3AudioFrameLayer)(value & 3); value >>= 2;
            Version = (MP3AudioFrameVersion)(value & 3); value >>= 2;
            if (value != 0x7FF)
            {
