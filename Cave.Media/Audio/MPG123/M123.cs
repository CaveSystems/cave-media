...
/// <summary>Provides direct access to the mpg123 functions.</summary>
public sealed class M123
{
    ...
    /// <summary>
    /// An enum over all sample types possibly known to mpg123. The values are designed as bit flags to allow bitmasking for encoding families. <br/> Note that
    /// (your build of) libmpg123 does not necessarily support all these. Usually, you can expect the 8bit encodings and signed 16 bit. Also 32bit float will be
    /// usual beginning with mpg123-1.7.0 . What you should bear in mind is that (SSE, etc) optimized routines may be absent for some formats. We do have SSE
    /// for 16, 32 bit and float, though. 24 bit integer is done via postprocessing of 32 bit output -- just cutting the last byte, no rounding, even. If you
    /// want better, do it yourself. <br/> All formats are in native byte order. If you need different endinaness, you can simply postprocess the output buffers
    /// (libmpg123 wouldn't do anything else). mpg123_encsize() can be helpful there. <br/>
    /// </summary>
    public enum ENC
    {
        /// <summary>No or unknown encoding</summary>
        NONE = 0,

        /// <summary>Some 8 bit integer encoding.</summary>
        DEFAULT_8 = 0x00f,

        /// <summary>Some 16 bit integer encoding.</summary>
        DEFAULT_16 = 0x040,

        /// <summary>Some 24 bit integer encoding.</summary>
        DEFAULT_24 = 0x4000,

        /// <summary>Some 32 bit integer encoding.</summary>
        DEFAULT_32 = 0x100,

        /// <summary>Some signed integer encoding.</summary>
        SIGNED = 0x080,

        /// <summary>Some float encoding.</summary>
        FLOAT = 0xe00,
        ...
        /// <summary>ulaw 8 bit</summary>
        ULAW_8 = 0x04,

        /// <summary>alaw 8 bit</summary>
        ALAW_8 = 0x08,
        ...
        /// <summary>signed 24 bit</summary>
        SIGNED_24 = DEFAULT_24 | SIGNED | 0x1000,

        /// <summary>unsigned 24 bit</summary>
        UNSIGNED_24 = DEFAULT_24 | 0x2000,

        /// <summary>32bit float</summary>
        FLOAT_32 = 0x200,

        /// <summary>64bit float</summary>
        FLOAT_64 = 0x400,

        /// <summary>Any encoding on the list.</summary>
        ANY =
    ...
    public enum FEATURE
    {
        /// <summary>mpg123 expects path names to be given in UTF-8 encoding instead of plain native.</summary>
        ABI_UTF8OPEN = 0,

        /// <summary>8bit output</summary>
        OUTPUT_8BIT,

        /// <summary>16bit output</summary>
        OUTPUT_16BIT,

        /// <summary>32bit output</summary>
        OUTPUT_32BIT,

        /// <summary>support for building a frame index for accurate seeking</summary>
        INDEX,

        /// <summary>id3v2 parsing</summary>
        PARSE_ID3V2,

        /// <summary>mpeg layer-1 decoder enabled</summary>
        DECODE_LAYER1,

        /// <summary>mpeg layer-2 decoder enabled</summary>
        DECODE_LAYER2,

        /// <summary>mpeg layer-3 decoder enabled</summary>
        DECODE_LAYER3,

        /// <summary>accurate decoder rounding</summary>
        DECODE_ACCURATE,

        /// <summary>downsample (sample omit)</summary>
        DECODE_DOWNSAMPLE,

        /// <summary>flexible rate decoding</summary>
        DECODE_NTOM,

        /// <summary>ICY support</summary>
        PARSE_ICY,

        /// <summary>Reader with timeout (network).</summary>
        TIMEOUT_READ,
    }

    /// <summary>Channel count flags: They can be combined into one number (3) to indicate mono and stereo...</summary>
    [Flags]
    public enum CHANNELCOUNT
    {
        /// <summary>No channels or error</summary>
        NONE = 0,
        ...
        /// <summary>Mono | Stereo</summary>
        BOTH = MONO | STEREO,
    }

    /// <summary>Flag bits for MPG123_FLAGS, use the usual binary or to combine.</summary>
    [Flags]
    public enum FLAGS : int
    {
        /// <summary>Force some mono mode: This is a test bitmask for seeing if any mono forcing is active.</summary>
        FORCE_MONO = 0x7,

        /// <summary>Force playback of left channel only.</summary>
        MONO_LEFT = 0x1,

        /// <summary>Force playback of right channel only.</summary>
        MONO_RIGHT = 0x2,

        /// <summary>Force playback of mixed mono.</summary>
        MONO_MIX = 0x4,

        /// <summary>Force stereo output.</summary>
        FORCE_STEREO = 0x8,

        /// <summary>Force 8bit formats.</summary>
        FORCE_8BIT = 0x10,

        /// <summary>Suppress any printouts (overrules verbose).</summary>
        QUIET = 0x20,

        /// <summary>Enable gapless decoding (default on if libmpg123 has support).</summary>
        GAPLESS = 0x40,

        /// <summary>Disable resync stream after error.</summary>
        NO_RESYNC = 0x80,

        /// <summary>Enable small buffer on non-seekable streams to allow some peek-ahead (for better MPEG sync).</summary>
        SEEKBUFFER = 0x100,

        /// <summary>Enable fuzzy seeks (guessing byte offsets or using approximate seek points from Xing TOC)</summary>
        FUZZY = 0x200,

        /// <summary>Force floating point output (32 or 64 bits depends on mpg123 internal precision).</summary>
        FORCE_FLOAT = 0x400,
        ...
        /// <summary>Ignore any stream length information contained in the stream, which can be contained in a 'TLEN' frame of an ID3v2 tag or a Xing tag</summary>
        IGNORE_STREAMLENGTH = 0x1000,

        /// <summary>Do not parse ID3v2 tags, just skip them.</summary>
        SKIid3V2 = 0x2000,

        /// <summary>Do not parse the LAME/Xing info frame, treat it as normal MPEG data.</summary>
        IGNORE_INFOFRAME = 0x4000,

        /// <summary>
        /// Allow automatic internal resampling of any kind (default on if supported). Especially when going lowlevel with replacing output buffer, you might
        /// want to unset this flag. Setting MPG123_DOWNSAMPLE or MPG123_FORCE_RATE will override this.
        /// </summary>
    ...
    public enum PARAMS
    {
        /// <summary>set verbosity value for enabling messages to stderr, &gt;= 0 makes sense (integer)</summary>
        VERBOSE = 0,

        /// <summary>set all flags, p.ex val = GAPLESS | MONO_MIX (integer)</summary>
        FLAGS,

        /// <summary>add some flags (integer)</summary>
        ADD_FLAGS,

        /// <summary>when value &gt; 0, force output rate to that value (integer)</summary>
        FORCE_RATE,

        /// <summary>0=native rate, 1=half rate, 2=quarter rate (integer)</summary>
        DOWN_SAMPLE,

        /// <summary>one of the RVA choices above (integer)</summary>
        RVA,

        /// <summary>play a frame N times (integer)</summary>
        DOWNSPEED,

        /// <summary>play every Nth frame (integer)</summary>
        UPSPEED,

        /// <summary>start with this frame (skip frames before that, integer)</summary>
        START_FRAME,

        /// <summary>decode only this number of frames (integer)</summary>
        DECODE_FRAMES,

        /// <summary>stream contains ICY metadata with this interval (integer)</summary>
        ICY_INTERVAL,

        /// <summary>the scale for output samples (amplitude - integer or float according to mpg123 output format, normally integer)</summary>
        OUTSCALE,

        /// <summary>timeout for reading from a stream (not supported on win32, integer)</summary>
        TIMEOUT,

        /// <summary>remove some flags (inverse of MPG123_ADD_FLAGS, integer)</summary>
        REMOVE_FLAGS,

        /// <summary>
        /// Try resync on frame parsing for that many bytes or until end of stream (&lt;0 ... integer). This can enlarge the limit for skipping junk on
        /// beginning, too (but not reduce it).
        /// </summary>
        RESYNC_LIMIT,

        /// <summary>
        /// Set the frame index size (if supported). Values &lt;0 mean that the index is allowed to grow dynamically in these steps (in positive direction, of
        /// course) -- Use this when you really want a full index with every individual frame.
        /// </summary>
        INDEX_SIZE,

        /// <summary>
        /// Decode/ignore that many frames in advance for layer 3. This is needed to fill bit reservoir after seeking, for example (but also at least one frame
        /// in advance is needed to have all "normal" data for layer 3). Give a positive integer value, please.
        /// </summary>
        PREFRAMES,

        /// <summary>
        /// For feeder mode, keep that many buffers in a pool to avoid frequent malloc/free. The pool is allocated on mpg123_open_feed(). If you change this
        /// parameter afterwards, you can trigger growth and shrinkage during decoding. The default value could change any time. If you care about this, then
        /// set it. (integer)
        /// </summary>
        FEEDPOOL,

        /// <summary>Minimal size of one internal feeder buffer, again, the default value is subject to change. (integer)</summary>
        FEEDBUFFER,
    }

    /// <summary>Enumeration of the message and error codes and returned by libmpg123 functions.</summary>
    public enum RESULT : int
    {
        /// <summary>Message: Track ended. Stop decoding.</summary>
        DONE = -12,

        /// <summary>
        /// Message: Output format will be different on next call. Note that some libmpg123 versions between 1.4.3 and 1.8.0 insist on you calling
        ///          mpg123_getformat() after getting this message code. Newer verisons behave like advertised: You have the chance to call mpg123_getformat(),
        ///          but you can also just continue decoding and get your data.
        /// </summary>
        NEW_FORMAT = -11,

        /// <summary>Message: For feed reader: "Feed me more!" (call mpg123_feed() or mpg123_decode() with some new input data).</summary>
        NEED_MORE = -10,
        ...
        /// <summary>Unable to set up output format!</summary>
        BAD_OUTFORMAT,

        /// <summary>Invalid channel number specified.</summary>
        BAD_CHANNEL,

        /// <summary>Invalid sample rate specified.</summary>
        BAD_RATE,

        /// <summary>Unable to allocate memory for 16 to 8 converter table!</summary>
        ERR_16TO8TABLE,

        /// <summary>Bad parameter id!</summary>
        BAD_PARAM,

        /// <summary>Bad buffer given -- invalid pointer or too small size.</summary>
        BAD_BUFFER,

        /// <summary>Out of memory -- some malloc() failed.</summary>
        OUT_OF_MEM,

        /// <summary>You didn't initialize the library!</summary>
        NOT_INITIALIZED,

        /// <summary>Invalid decoder choice.</summary>
        BAD_DECODER,

        /// <summary>Invalid mpg123 handle.</summary>
        BAD_HANDLE,

        /// <summary>Unable to initialize frame buffers (out of memory?).</summary>
        NO_BUFFERS,

        /// <summary>Invalid RVA mode.</summary>
        BAD_RVA,

        /// <summary>This build doesn't support gapless decoding.</summary>
        NO_GAPLESS,

        /// <summary>Not enough buffer space.</summary>
        NO_SPACE,

        /// <summary>Incompatible numeric data types.</summary>
        BAD_TYPES,

        /// <summary>Bad equalizer band.</summary>
        BAD_BAND,

        /// <summary>Null pointer given where valid storage address needed.</summary>
        ERR_NULL,

        /// <summary>Error reading the stream.</summary>
        ERR_READER,

        /// <summary>Cannot seek from end (end is not known).</summary>
        NO_SEEK_FROM_END,

        /// <summary>Invalid 'whence' for seek function.</summary>
        BAD_WHENCE,

        /// <summary>Build does not support stream timeouts.</summary>
        NO_TIMEOUT,

        /// <summary>File access error.</summary>
        BAD_FILE,

        /// <summary>Seek not supported by stream.</summary>
        NO_SEEK,

        /// <summary>No stream opened.</summary>
        NO_READER,

        /// <summary>Bad parameter handle.</summary>
        BAD_PARS,

        /// <summary>Bad parameters to mpg123_index() and mpg123_set_index()</summary>
        BAD_INDEX_PAR,

        /// <summary>Lost track in bytestream and did not try to resync.</summary>
        OUT_OF_SYNC,

        /// <summary>Resync failed to find valid MPEG data.</summary>
        RESYNC_FAIL,

        /// <summary>No 8bit encoding possible.</summary>
        NO_8BIT,

        /// <summary>Stack aligmnent error</summary>
        BAD_ALIGN,

        /// <summary>NULL input buffer with non-zero size...</summary>
        NULbUFFER,

        /// <summary>Relative seek not possible (screwed up file offset)</summary>
        NO_RELSEEK,

        /// <summary>You gave a null pointer somewhere where you shouldn't have.</summary>
        NULL_POINTER,

        /// <summary>Bad key value given.</summary>
        BAD_KEY,

        /// <summary>No frame index in this build.</summary>
        NO_INDEX,

        /// <summary>Something with frame index went wrong.</summary>
        INDEX_FAIL,

        /// <summary>Something prevents a proper decoder setup</summary>
        BAD_DECODER_SETUP,

        /// <summary>This feature has not been built into libmpg123.</summary>
        MISSING_FEATURE,

        /// <summary>A bad value has been given, somewhere.</summary>
        BAD_VALUE,

        /// <summary>Low-level seek failed.</summary>
        LSEEK_FAILED,

        /// <summary>Custom I/O not prepared.</summary>
        BAD_CUSTOM_IO,

        /// <summary>Offset value overflow during translation of large file API calls -- your client program cannot handle that large file.</summary>
        LFS_OVERFLOW,

        /// <summary>Some integer overflow.</summary>
        INT_OVERFLOW,
    }

    /// <summary>RVA choices.</summary>
    public enum RVA
    {
        /// <summary>RVA disabled (default).</summary>
        OFF = 0,

        /// <summary>Use mix/track/radio gain.</summary>
        MIX = 1,

        /// <summary>Use album/audiophile gain</summary>
        ALBUM = 2,
    }
    ...
    public sealed class M123_PARS
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="M123_PARS"/> class.</summary>
        public M123_PARS()
        {
            Handle = IntPtr.Zero;
        }

        /// <summary>Finalizes an instance of the <see cref="M123_PARS"/> class.</summary>
        ~M123_PARS()
        {
        ...
        /// <summary>Creates new MPG123_PARS with the specified handle.</summary>
        ...
        /// <summary>Gets whether the handle is valid or not.</summary>
    ...
    /// <summary>Gets the MPG123_ENC value for the specified IAudioConfiguration.</summary>
    ...
    /// <summary>Gets the MPG123_CHANNELCOUNT value for the specified IAudioConfiguration.</summary>
    ...
    /// <summary>Initialized the mpg123 library (you have to call Deinitialize for each call to this function).</summary>
    ...
    internal static class SafeNativeMethods
    {
        ...
        /// <summary>
        /// Function to initialise the mpg123 library. This function is not thread-safe. Call it exactly once per process, before any other (possibly threaded)
        ...
        /// <summary>Function to close down the mpg123 library. This function is not thread-safe. Call it exactly once per process.</summary>
        [DllImport(NATIVE_LIBRARY, CallingConvention = CallingConvention.Cdecl)]
        public static extern void mpg123_exit();

        /// <summary>
        /// Create a handle with optional choice of decoder (named by a string, see mpg123_decoders() or mpg123_supported_decoders()). and optional retrieval of
        /// an error code to feed to mpg123_plain_strerror(). Optional means: Any of or both the parameters may be NULL.
        /// </summary>
        ...
        /// <summary>Delete handle, mh is either a valid mpg123 handle or NULL.</summary>
        /// <param name="handle"></param>
        [DllImport(NATIVE_LIBRARY, CallingConvention = CallingConvention.Cdecl)]
        ...
        /// <summary>Get a specific parameter, for a specific mpg123_handle. See the MPG123_PARAMS enumeration for a list of available parameters.</summary>
        /// <param name="handle"></param>
        /// <param name="type"></param>
        /// <param name="value"></param>
        /// <param name="floatValue"></param>
        ...
        /// <summary>Query libmpg123 feature, 1 for success, 0 for unimplemented functions.</summary>
        /// <param name="key"></param>
        /// <returns></returns>
        [DllImport(NATIVE_LIBRARY, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool mpg123_feature(FEATURE key);

        #endregion mpg123 library and handle setup

        #region mpg123 error handling

        /// <summary>Return a string describing that error errcode means.</summary>
        ...
        /// <summary>
        /// Give string describing what error has occured in the context of the handle. When a function operating on an mpg123 handle returns MPG123_ERR, you
        /// should check for the actual reason via char *errmsg = mpg123_strerror(mh) This function will catch mh == NULL and return the message for MPG123_BAD_HANDLE.
        /// </summary>
        /// <param name="handle"></param>
        /// <returns></returns>
        [DllImport(NATIVE_LIBRARY, CallingConvention = CallingConvention.Cdecl)]
        ...
        /// <summary>Return the plain errcode intead of a string.</summary>
        /// <param name="handle"></param>
        /// <returns></returns>
        [DllImport(NATIVE_LIBRARY, CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT mpg123_errcode(IntPtr handle);

        #endregion mpg123 error handling
        ...
        /// <summary>Returns an array of generally available decoder names (plain 8bit ASCII).</summary>
        ...
        /// <summary>Return a NULL-terminated array of the decoders supported by the CPU (plain 8bit ASCII).</summary>
        ...
        /// <summary>Set the chosen decoder to 'decoder_name'.</summary>
        /// <param name="handle"></param>
        ...
        /// <summary>
        /// Get the currently active decoder engine name. The active decoder engine can vary depening on output constraints, mostly non-resampling, integer
        /// output is accelerated via 3DNow &amp; Co. but for other modes a fallback engine kicks in. Note that this can return a decoder that is ony active in
        /// the hidden and not available as decoder choice from the outside.
        /// </summary>
        /// <param name="handle"></param>
        ...
        #endregion mpg123 decoder selection
        ...
        /// <summary>
        /// An array of supported standard sample rates These are possible native sample rates of MPEG audio files. You can still force mpg123 to resample to a
        /// different one, but by default you will only get audio in one of these samplings.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>Return the size (in bytes) of one mono sample of the named encoding.</summary>
        ...
        /// <summary>Configure a mpg123 handle to accept no output format at all, use before specifying supported formats with mpg123_format.</summary>
        /// <param name="handle"></param>
        /// <returns></returns>
        [DllImport(NATIVE_LIBRARY, CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT mpg123_format_none(IntPtr handle);

        /// <summary>Configure mpg123 handle to accept all formats (also any custom rate you may set) -- this is default.</summary>
        /// <param name="handle"></param>
        /// <returns></returns>
        [DllImport(NATIVE_LIBRARY, CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT mpg123_format_all(IntPtr handle);

        /// <summary>Set the audio format support of a mpg123_handle in detail:.</summary>
        ...
        /// A combination of accepted encodings for rate and channels, p.ex MPG123_ENC_SIGNED16 | MPG123_ENC_ULAW_8 (or 0 for no support). Please note that some
        /// encodings may not be supported in the library build and thus will be ignored here.
        /// </param>
        ...
        /// <summary>Check to see if a specific format at a specific rate is supported by mpg123_handle.</summary>
        /// <param name="handle"></param>
        /// <param name="sampleRate"></param>
        /// <param name="encoding"></param>
        /// <returns>
        /// MPG123_CHANNELCOUNT.NONE for no support (that includes invalid parameters), MPG123_CHANNELCOUNT.STEREO, MPG123_CHANNELCOUNT.MONO or MPG123_CHANNELCOUNT.BOTH.
        /// </returns>
        [DllImport(NATIVE_LIBRARY, CallingConvention = CallingConvention.Cdecl)]
        ...
        /// <summary>Get the current output format.</summary>
        /// <param name="handle"></param>
        /// <returns></returns>
        ...
        #endregion mpg123 output audio format

        #region mpg123 file input and decoding

        /// <summary>
        /// Open and prepare to decode the specified file by filesystem path. This does not open HTTP urls; libmpg123 contains no networking code. If you want
        /// to decode internet streams, use mpg123_open_fd() or mpg123_open_feed().
        /// </summary>
        /// <param name="handle"></param>
        ...
        /// <summary>Use an already opened file descriptor as the bitstream input mpg123_close() will _not_ close the file descriptor.</summary>
        /// <param name="handle"></param>
        ...
        /// <summary>
        /// Use an opaque handle as bitstream input. This works only with the replaced I/O from mpg123_replace_reader_handle()! mpg123_close() will call the
        ...
        /// <summary>Closes the source, if libmpg123 opened it.</summary>
        /// <param name="handle"></param>
        /// <returns></returns>
        [DllImport(NATIVE_LIBRARY, CallingConvention = CallingConvention.Cdecl)]
        ...
        /// <summary>Read from stream and decode up to BufferSize bytes.</summary>
        /// <param name="handle"></param>
        ...
        /// <summary>
        /// Decode MPEG Audio from inmemory to outmemory. This is very close to a drop-in replacement for old mpglib. When you give zero-sized output buffer the
        /// input will be parsed until decoded data is available. This enables you to get MPG123_NEW_FORMAT (and query it) without taking decoded data. Think of
        /// this function being the union of mpg123_read() and mpg123_feed() (which it actually is, sort of;-). You can actually always decide if you want those
        /// specialized functions in separate steps or one call this one here.
        /// </summary>
        /// <param name="handle"></param>
        ...
        #endregion mpg123 file input and decoding
        ...
        /// <summary>Get the safe output buffer size for all cases (when you want to replace the internal buffer).</summary>
        /// <returns></returns>
        public static int mpg123_safe_buffer() => m_mpg123_safe_buffer().ToInt32();

        #endregion mpg123 status and information
        ...
        /// <summary>Create a handle with preset parameters.</summary>
        ...
        /// <summary>Allocate memory for and return a new MPG123_PARS.</summary>
        /// <param name="preset"></param>
        /// <returns></returns>
        ...
        /// <summary>Delete and free up memory used by a MPG123_PARS data structure.</summary>
        /// <param name="preset"></param>
        ...
        /// <summary>Configure mpg123 parameters to accept no output format at all, use before specifying supported formats with mpg123_format.</summary>
        /// <param name="preset"></param>
        /// <returns></returns>
        ...
        /// <summary>Set the audio format support of a mpg123_pars in detail.</summary>
        /// <param name="preset"></param>
        /// <param name="config"></param>
        /// <returns></returns>
        ...
        /// <summary>Check to see if a specific format at a specific rate is supported by MPG123_PARS.</summary>
        /// <param name="preset"></param>
        /// <param name="config"></param>
        /// <returns></returns>
        ...
        /// <summary>Get a specific parameter, for a specific mpg123_pars. See the MPG123_PARAMS enumeration for a list of available parameters.</summary>
        /// <param name="preset"></param>
        /// <param name="type"></param>
        /// <param name="value"></param>
        /// <param name="floatValue"></param>
        ...
        #endregion mpg123 advanced parameter API
    }
}
