...
/// <summary>Provides a renderer using OpenGL and <see href="http://www.glfw.org/">GLFW3</see>.</summary>
public class Glfw3Renderer : IRenderer, IDisposable
{
    ...
    /// <summary>Finalizes an instance of the <see cref="Glfw3Renderer"/> class. Disposes all unmanaged resources.</summary>
    ~Glfw3Renderer()
    {
        Dispose(false);
    }
    ...
    void PrepareBuffers()
    {
        ...
        gl2.GenBuffers(2, buffers);
        {
            ...
            // send vertices data to opengl ! 2nd paramater is length of array in bytes, send as IntPtr (not pointer of size variable)
            gl2.BufferData(GL._ARRAY_BUFFER, new IntPtr(2 * 4 * 4), quad, GL._STATIC_DRAW);
            gl2.EnableVertexAttribArray(ShaderVertexPosition);

            // hint opengl at structure of data in bound buffer to use as vertex attribute attribute index, 3 values / vertex, type float, no normalization, no
            // stride, no offset
    ...
    /// <summary>Disposes all unmanaged and if specified all managed resources of the renderer.</summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Glfw3Renderer"/> class. This always succeeds. Please check <see cref="IsAvailable"/> after construction.
    /// </summary>
    ...
    /// <summary>Provides a callback after the user closed the window</summary>
    public event EventHandler<EventArgs>? Closed;

    /// <summary>Provides a callback when the framebuffer size changes</summary>
    public event EventHandler<glfw3.SizeEventArgs>? FrameBufferChanged;

    /// <summary>Provides a callback for mouse button events</summary>
    ...
    /// <summary>Gets or sets the aspect correction mode to use.</summary>
    ...
    /// <summary>Gets the description of the Renderer.</summary>
    public string Description { get; }

    /// <summary>Gets a value indicating whether the renderer is available or not.</summary>
    public bool IsAvailable { get; }

    /// <summary>Gets the maximum texture size for a openGL texture on the current device.</summary>
    public int MaxTextureSize { get; private set; }

    /// <summary>Gets the name of the Renderer.</summary>
    public string Name { get; }

    /// <summary>Gets the resolution of the backbuffer.</summary>
    ...
    /// <summary>Closes the renderer.</summary>
    public void Close() => Dispose();

    /// <summary>Creates a new <see cref="IRenderSprite"/> instance.</summary>
    ...
    /// <summary>Disposes all unmanaged and managed resources of the renderer.</summary>
    public void Dispose()
    {
        Dispose(true);
    ...
    /// <summary>Displays the current backbuffer.</summary>
    public void Present()
    {
        if (!Window.IsValid)
        {
    ...
    /// <summary>Renders sprite instances to the backbuffer.</summary>
    ...
    /// <summary>Sets the size of the underlying glfw3 window.</summary>
    ...
    /// <summary>Sets the title of the underlying glfw3 window.</summary>
