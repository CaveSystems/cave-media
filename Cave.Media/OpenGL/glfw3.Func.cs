namespace Cave.Media.OpenGL
{
    ...
    public static partial class glfw3
    {
        ...
        /// <see cref="GetMouseButton"/> returns <see cref="InputState.Press"/> the
        ...
        /// machines that support <c>_KHR_context_flush_control</c>, you can control whether a
        ...
        /// <para>Contexts that support either of the <c>W_EXT_swap_control_tear</c> and
