...
namespace Cave.Media.OpenGL
{
    public static partial class glfw3
    {
        ...
        public enum Hint
        {
            ...
            /// OpenGL context will support the <c>_FRAMEBUFFER_SRGB</c> enable, also called
            /// <c>_FRAMEBUFFER_SRGB_EXT</c>) for controlling sRGB rendering and a created OpenGL
            ...
            /// <summary>
            /// Specifies which <see cref="glfw3.ClientApi"/> to create the context for.
            /// </summary>
            ...
            /// <summary>
            /// Specifies the <see cref="glfw3.ContextRobustness"/> to be used by the context.
            /// </summary>
            ...
            /// <summary>
            /// Specifies the <see cref="glfw3.ContextReleaseBehavior"/> to be used by the context.
