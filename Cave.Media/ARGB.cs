...
public struct ARGB : IComparable, IComparable<int>, IComparable<ARGB>
{
    ...
    public static ARGB Random
    {
        get
        {
            unchecked
            {
                var hue = (RNG.UInt32 % 36000) / 36000f;
    ...
    /// <summary>
    /// Loads (copies) the struct from a specified string. The string may start with '#' (HtmlColor), '0x' (default hexadecimal), be a plain hexadecimal value
    /// or any known color name (e.g. black, white, ...)
    /// </summary>
    ...
    public HueColor HueColor
    {
        get
        {
            ...
            // Hue 0..1 = 0..360° -> -30°..30° = index 1 index = (Hue * 360 - 30) / 60 + 1
    ...
    #endregion IComparable<int> Member
    ...
    #endregion IComparable<ARGB> Member
