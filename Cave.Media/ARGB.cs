...
namespace Cave.Media
{
    ...
    public struct ARGB : IComparable, IComparable<int>, IComparable<ARGB>
    {
        ...
        /// <param name="v1"></param>
        /// <param name="v2"></param>
        /// <returns>Returns true if the values are inequal.</returns>
        public static bool operator !=(ARGB v1, ARGB v2)
        {
            return v1.AsUInt32 != v2.AsUInt32;
        }
        ...
        /// </summary>
        public static ARGB Transparent { get { return default(ARGB); } }
        #endregion
        ...
        public static ARGB FromHSI(float hue, float saturation, float intensity)
        {
            ...
            {
                return hi == 4 ? FromColor(255, t, p, v) : FromColor(255, v, p, q);
            }
        }
        ...
        public HueColor HueColor
        {
            get
            {
                ...
                {
                    // gray
                    return luminance < 0.5f ? HueColor.Dark : HueColor.Light;
                }
        ...
        /// <summary>
        /// Checks whether the color looks red.
        /// </summary>
        public bool IsRed
        {
            get
            {
                return IsGray ? false : (Red > Blue + 25) && (Red > Green + 25);
            }
        }

        /// <summary>
        /// Checks whether the color looks blue.
        /// </summary>
        public bool IsBlue
        {
            get
            {
                return IsGray ? false : (Blue > Red + 25) && (Blue > Green + 25);
            }
        }

        /// <summary>
        /// Checks whether the color looks green.
        /// </summary>
        public bool IsGreen
        {
            get
            {
                return IsGray ? false : (Green > Blue + 25) && (Green > Red + 25);
            }
        }
        ...
        /// <summary>
        /// Retrieves if a bit was set at the specified index.
        /// </summary>
        ...
        /// <summary>
        /// Provides a color with the structs values.
        /// </summary>
        ...
        /// <summary>
        /// Provides a gray scaled percent value with the structs color values.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves the alpha percentage.
        /// </summary>
        ...
        {
            return obj is ARGB other ? other.AsUInt32 == AsUInt32 : false;
        }
