...
namespace Cave.Media
{
    ...
    public struct ARGB : IComparable, IComparable<int>, IComparable<ARGB>
    {
        ...
        /// <summary>
        /// Obtains a transparent value
        /// </summary>
        public static ARGB Transparent { get { return new ARGB(); } }
        #endregion
        ...
        {
            if (heat < 0) throw new ArgumentOutOfRangeException(nameof(heat));
        ...
        #region struct properties
        /// <summary>
        /// Provides a gray scaled byte value with the structs color values
        /// </summary>
