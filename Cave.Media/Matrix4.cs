...
namespace Cave.Media
{
    ...
    public struct Matrix4 
    {
        ...
        public static Matrix4 Parse(string text)
        {
            ...
            if (!text.StartsWith("[(") || !text.EndsWith(")]")) throw new FormatException();
            string[] l_Vectors = text.Substring(2, text.Length - 4).Split(new string[] { "), (" }, StringSplitOptions.None);
            if (l_Vectors.Length != 4) throw new FormatException();
        ...
        public static Matrix4 FromColumns(Vector4[] vectors)
        {
            ...
            if (vectors.Length != 4) throw new ArgumentException(string.Format("Number of values do not match!"));
