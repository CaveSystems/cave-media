...
namespace Test
{
    class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            {
                Console.ForegroundColor = ConsoleColor.Green;
                Console.WriteLine($"---: info TI9999: All tests successfully completed at framework {Environment.Version} bits {IntPtr.Size * 8}.");
            }
            else
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine($"---: error TE9999: {errors} tests failed framework {Environment.Version} bits {IntPtr.Size * 8}!");
            }
